# Event model
## Overview
It consists of an external event defined by [event reception API](278 _ Event _ Reception.md) and an internal event defined within Personium.

![Event model](image/eventmodel.png "event model")


#### External event
Represents an event to be accepted in [Event reception API](278 _ Event _ Reception.md).
