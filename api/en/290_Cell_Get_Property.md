...
|cellstatus|p:|Element<br>|Cell status<br>normal:Cell imported successfuly<br>import failed:Cell import failed|When the status of Cell is import failed, execution other than the following API can not be executed<br>- Unit Level API<br>- OAuth2.0 token endpoint<br>- Cell Import|
