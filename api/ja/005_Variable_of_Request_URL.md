...
|{CellURL}|Cellにアクセスする為のURL<br>CellURLには"path based cell URL"と"per cell FQDN URL"の2種類が存在し、[プロパティ](../../server-operator/unit_config_list.md)で切替可能|path based cell URL:https://{UnitFQDN}{CellURL}/<br>per cell FQDN URL:https:/{CellURL}.{UnitFQDN}/|
