...
```
/{Cell_name}/__ctl/Account(Name='{account_name}')/_Role
または、
/{Cell_name}/__ctl/Account('{account_name}')/_Role
```
#### メソッド
GET
#### リクエストクエリ
...
|{2}<br>|Type<br>|string<br>|CellCtl.Account<br>|
##### レスポンスサンプル
```json
{
  "d": {
...
```sh
curl "https://fqdn/cell_name/__ctl/Account('account_name')/_Role" -X GET -i -H 'Authorization: Bearer auth_token' -H 'Accept: application/json'
```
<br>
<br>
<br>
