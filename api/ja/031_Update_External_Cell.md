...
#### リクエストURL
```
/{cellname}/__ctl/ExtCell('http%3A%2F%2Ffqdn%2Fcellname')
```
#### メソッド
PUT
...
#### CURLコマンド(UNIX)
```sh
curl "https://fqdn/cell_name/__ctl/ExtCell('http%3A%2F%2Ffqdn%2Fcellname')" -X PUT -i -H 'If-Match: *' -H 'Authorization: Bearer auth_token' -H 'Accept: application/json'
