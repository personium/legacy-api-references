...
#### リクエストURL
```
/{cell_name}/__ctl/ExtCell('http%3A%2F%2Ffqdn%2Fcellname')
```
#### メソッド
GET
...
#### CURLコマンド(UNIX)
```sh
curl "https://fqdn/cell_name/__ctl/ExtCell('http%3A%2F%2Ffqdn%2Fcell_name')" -X GET -i -H 'Authorization: Bearer auth_token' -H 'Accept: application/json'
```
<br>
<br>
<br>
