...
#### CURLコマンド(UNIX)
```sh
curl "https://fqdn/Cell_name/__ctl/ExtCell('https%3A%2F%2Ffqdn%2Fcellname')/$link/_Role" -X POST -i  -H 'Authorization: Bearer auth_token' -H 'Accept: application/json' -d '{"uri":"https://fqdn/cell_name/__ctl/Role('role_name')/"}'
```
<br>
<br>
<br>
