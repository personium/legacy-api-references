  ...
  "d": {
    "results": {
      ...
      "__metadata": {
        ...
        "uri": "https://{UnitFQDN}/{CellName}/__ctl/ExtRole(ExtRole='https://{UnitFQDN}/{CellName}/__role/__/RoleName',_Relation.Name='relation',_Relation._Box.Name=null)"
      },
...
#### CURLコマンド(UNIX)
```sh
curl "https://{UnitFQDN}/{CellName}/__ctl/ExtRole(ExtRole='https%3A%2F%2F{UnitFQDN}%2F{CellName}%2F__role%2F__%2Froletest',_Relation.Name='relation',_Relation._Box.Name='box')" -X GET -i -H 'Authorization: Bearer {UnitUserToken}' -H 'Accept: application/json'
```
<br>
<br>
<br>
