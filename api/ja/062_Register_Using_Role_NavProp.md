...
```json
{
  "ExtRole": "https://fqdn/cellname/__role/__/roletest",
...
##### ExtRoleを登録する場合
```sh
curl "https://fqdn/cell_name/__ctl/Relation('relation_name')/_ExtRole" -X POST -v \
-d '{"ExtRole":"relation","_Relation.Name":"relation_name","_Relation._Box.Name":"box"}' -i -k \
