...
#### リクエストURL
```
/{cell_name}/__ctl/ReceivedMessage('MessageID')
```
#### メソッド
GET
#### リクエストクエリ
  ...
  "d": {
    "results": {
      ...
      "__metadata": {
        ...
        "uri": "https://fqdn/cell_name/__ctl/ReceivedMessage('hnKXm44TTZCw-bfSEw4f0A')"
      },
...
#### CURLコマンド(UNIX)
```sh
curl "https://fqdn/__ctl/ReceivedMessage('MessageID')" -X GET -i  -H 'Authorization: Bearer auth_token' -H 'Accept: application/json'
```
<br>
<br>
<br>
