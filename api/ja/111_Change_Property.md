...
<multistatus xmlns="DAV:">
    <response>
        <href>http://localhost:9998/test_cell1/box_name1/patchcol</href>
        <propstat>
            <prop>
...
#### CURLコマンド(UNIX)
```sh
curl "https://fqdn/cell' -X PROPPATCH -i -H 'Authorization: Bearer auth_token' -H 'Accept: application/json' -d '<?xml version="1.0" encoding="utf-8" ?>  <D:propertyupdate xmlns:D="DAV:"
xmlns:dc="urn:x-dc1:xmlns" xmlns:Z="http://www.w3.com/standards/z39.50/"><D:set><D:prop>
<Z:Author>${author1}</Z:Author><dc:hoge>${hoge}</dc:hoge></D:prop></D:set><D:remove>
<D:prop><Z:Author/><dc:hoge/></D:prop></D:remove></D:propertyupdate>'
```
<br>
<br>
<br>
