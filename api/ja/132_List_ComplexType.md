  ...
  "d": {
    "results": [
      ...
      },
      {
        ...
        "Name": "NestedColumn",
        "__published": "/Date(1349323504818)/",
        "__updated": "/Date(1349323504818)/",
        "__metadata": {
...
#### CURLコマンド(UNIX)
```sh
curl 'https://fqdn/cell_name/box_name/odata_colleciton_path/$metadata/ComplexType' -X GET -v -k -H 'Authorization:Bearer auth_token'
```
<br>
<br>
<br>
